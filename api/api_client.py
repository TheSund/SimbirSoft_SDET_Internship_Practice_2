...
class ApiClient:
    ...
    @allure.step('[POST] Создание сущности')
    ...
    @allure.step('[DELETE] Удаление сущности (ID: {entity_id})')
    ...
    @allure.step('[GET] Получение данных о сущности (ID: {entity_id})')
    ...
    @allure.step('[GET] Получение списка сущностей')
    ...
    @allure.step('[PATCH] Обновление данных о сущности (ID: {entity_id})')
